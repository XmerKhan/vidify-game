...
export default function ContactPage() {
  ...
  return (
    <div className="container-content py-10 max-w-2xl">
      ...
      <div className="card p-5 mb-8 flex items-center gap-4 bg-brand-50 border-brand-200">
        <Mail className="h-8 w-8 text-brand-600 shrink-0" />
        <div>
          <h3 className="text-sm font-semibold text-ink-900">Email us directly</h3>
          <a href="mailto:vidifygamesinfo@gmail.com" className="text-lg font-semibold text-brand-700 hover:underline">
            vidifygamesinfo@gmail.com
          </a>
          <p className="text-xs text-ink-500 mt-0.5">The fastest way to reach us — we read every message.</p>
        </div>
      </div>
      ...
      <div className="mt-8 grid sm:grid-cols-2 gap-4">
        <div className="card p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <a href="mailto:vidifygamesinfo@gmail.com" className="text-sm text-ink-500 hover:text-brand-700">vidifygamesinfo@gmail.com</a>
          </div>
        </div>
        <div className="card p-4 flex items-center gap-3">
